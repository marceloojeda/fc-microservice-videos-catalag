...
trait TestSaves
{
    protected function assertStore(array $sendData, array $testDatabase, array $testJsonData = null): TestResponse
    {
        ...
        $this->assertInJsonResponseContent($response, $testDatabase, $testJsonData);
        return $response;
    }
    ...
    private function assertInJsonResponseContent(TestResponse $response, array $testDatabase, array $testJsonData = null)
    {
